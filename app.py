...
class App(FirebaseAuthenticator, RealtimeDB):
    ...
    def sidebar(self):
        ...
        st.sidebar.info(
            """
            # About
            - Team: [**_Elshad Sabziyev_**](https://github.com/elshadsabziyev), [**_Elvin Mammadov_**](https://github.com/elvinmammadov), and [**_Arif Najafov_**](https://github.com/arifnajafov).
